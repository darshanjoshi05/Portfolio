export const PERSON = {
  ...
  bio: ["I'm a Software Engineer building AI systems, full stack applications, and backend services. Currently a Research Assistant at Lawrence Technological University, working on real-time computer vision systems and deep learning research.",
"My work spans computer vision (YOLOv8, PyTorch), full stack development (FastAPI, React, SQLite), NLP pipelines, database design (MySQL, 3NF), Docker deployment, and cybersecurity research.",

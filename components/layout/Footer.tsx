...
export default function Footer() {
  return (
    <footer className="relative z-10 border-t border-white/[0.06] px-6 md:px-16 py-12">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-8 mb-8">
          ...
          <div>
            ...
            <p className="text-[0.65rem] text-muted/50 mt-0.5">Southfield, MI · Open to Opportunities</p>
          </div>
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-5">
          <span className="text-[0.63rem] text-muted/50 font-mono">
          ...
          <div className="flex items-center gap-3">
            {[
              { href: 'https://github.com/darshanjoshi05', label: 'GitHub', Icon: GithubIcon },
              { href: 'https://linkedin.com/in/darshanjoshi05', label: 'LinkedIn', Icon: LinkedInIcon },
              { href: 'mailto:joshidarshan193@gmail.com', label: 'Email', Icon: EmailIcon },
            ].map(({ href, label, Icon }) => (

...
export const metadata: Metadata = {
  ...
  description:
    'Darshan Joshi has 4 peer-reviewed publications spanning enterprise cybersecurity infrastructure (IJARESM 2023), AI classroom behavior detection with YOLOv8 (IJSRST), CNN-LSTM earthquake prediction (American Journal of Civil Engineering, 2025), and NLP-driven resume generation.',
  keywords: [
  ...
  openGraph: {
    title: 'Research & Publications — Darshan Joshi',
    description: '4 peer-reviewed papers by Darshan Joshi in cybersecurity, computer vision, seismic deep learning, and NLP.',

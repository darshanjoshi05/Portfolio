...
export const metadata: Metadata = {
  ...
  description:
'Darshan Joshi is an AI Engineer and MS Computer Science graduate (GPA 3.75/4.0) at Lawrence Technological University. Specializes in Computer Vision (YOLOv8), NLP, FastAPI, PyTorch, and Cybersecurity. 5 peer-reviewed publications. EC-Council certified. Research Assistant at Lawrence Tech.',
  keywords: [
    'Darshan Joshi',
  ...
  twitter: {
    ...
    title: 'Darshan Joshi — AI Engineer | Computer Vision & NLP',
    description:
'Darshan Joshi · AI Engineer · Computer Vision · NLP · Cybersecurity · 5 Publications · MS CS @ Lawrence Tech · Southfield, MI',
